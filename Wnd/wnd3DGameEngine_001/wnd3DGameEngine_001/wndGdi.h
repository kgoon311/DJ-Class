...
#pragma once
#include <Windows.h> //윈도우 GDI를 클래스화 시킴
#include <string> //STL 문자열
#include <vector> //STL vector
#include <cassert> //에러 처리
#include "Vector2D.h"
...
#define gdi wndGdi::Instance() //싱글톤
...
public:
	enum {
		red, blue, green, black, white, gray, pink, yellow,
