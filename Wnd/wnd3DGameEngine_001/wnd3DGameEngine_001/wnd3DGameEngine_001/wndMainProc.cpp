...
int OnKeyDown(HWND hWnd, WPARAM wParam, LPARAM lParam)
{
    ...
    case 'R':          nTheta += 1;             break;
    case 'E':          nTheta -= 1;             break;
    case 'S':          fSize += 0.1f;           break;
    case 'A':          fSize -= 0.1f;           break;
    case 'D':          matrix.RotateX(1);    break;
    case 'F':          matrix.RotateY(1);    break;
    case 'G':          matrix.RotateZ(1);    break;
    }

    if (nTheta >= 360)   nTheta = 0;
