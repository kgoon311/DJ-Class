...
{
	float s = sin(tho * 3.14 / 180);
	float c = cos(tho * 3.14 / 180);

	m11 = m11 + 1.f, m12 = m12 + 0.f; m13 = m13 + 0.f; m14 = 0.f;
	m21 = m21 + 0.f, m22 = m22 + s	; m23 =	m23 + c  ; m24 = 0.f;
	m31 = m31 + 0.f, m32 = m32 + c	; m33 =	m33 + -s ; m34 = 0.f;
	m41 = m41 + 0.f, m42 = m42 + 0.f; m43 = m43 + 0.f; m44 = 1.f;
}
...
void Matrix44::RotateY(int tho)
{
	...
	m11 = m11 + s	; m12 =m12 +0.f; m13 = m13 + c	; m14 = m14 + 0.f;
	m21 = m21 + 0.f	; m22 =m22 +1.f; m23 = m23 +0.f	; m24 = m24 + 0.f;
	m31 = m31 + c	; m32 =m32 +0.f; m33 = m33 + -s	; m34 = m34 + 0.f;
	m41 = m41 + 0.f	; m42 =m42 +0.f; m43 = m43 +0.f	; m44 = m44 + 1.f;
}
...
void Matrix44::RotateZ(int tho)
{
	...
	m11 = m11 + s	; m12 = m12 + c		; m13 = m13 +0.f; m14 = m14 +0.f;
	m21 = m21 + c	; m22 = m22 + -s	; m23 = m23 +0.f; m24 = m24 +0.f;
	m31 = m31 + 0.f	; m32 = m32 + 0.f	; m33 = m33 +1.f; m34 = m34 +0.f;
	m41 = m41 + 0.f	; m42 = m42 + 0.f	; m43 = m43 +0.f; m44 = m44 +1.f;
}
...
Vertex Matrix44::Transform(Vertex v)
{
	...
	ver.x = v.x * m11; ver.x = v.y * m12; ver.x = v.z * m13; ver.x = v.w * m14;
	ver.y = v.x * m21; ver.y = v.y * m22; ver.y = v.z * m23; ver.y = v.w * m24;
	ver.z = v.x * m31; ver.z = v.y * m32; ver.z = v.z * m33; ver.z = v.w * m34;
	ver.w = v.x * m41; ver.w = v.y * m42; ver.w = v.z * m43; ver.w = v.w * m44;
